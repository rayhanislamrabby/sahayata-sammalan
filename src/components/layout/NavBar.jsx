        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 w-[80%] max-w-xs h-fit max-h-[95vh] overflow-y-auto bg-white lg:hidden z-[102] shadow-2xl p-8 flex flex-col rounded-br-3xl"
            >
              <div className="flex justify-between items-center mb-10">
                <div className="flex flex-col leading-none">
                  ...
                  <span className="text-[10px] font-bold text-[#009661] tracking-widest uppercase">
                    Sammalan
                  </span>
                </div>
                <button
              ...
              <div className="mt-8">
                <Link
                  href="/donate"
                  onClick={() => setIsOpen(false)}
                  className="w-full flex items-center justify-center gap-3 bg-[#009661] py-4 rounded-2xl text-white font-black uppercase tracking-widest active:scale-95 transition-all shadow-lg hover:shadow-green-200"
                >
